            ...
            <div className=" border border-gray-300 px-8 max-sm:px-4 rounded-xl">
                ...
                <div className="flex justify-between items-center max-sm:mt-4">
                    ...
                    <div className="border-2 border-slate-300 p-2 mx-2 max-sm:border-1 ">
                        <div className="flex justify-center items-center border-b-2 border-slate-300 max-sm:border-1">
                            ...
                            <p className="pt-1 text-lg font-bold text-green-600 max-sm:text-sm"  >{headerdata?.avgRatingString}</p>
                        </div>
                        <p className="text-gray-500 font-semibold max-sm:text-sm ">{headerdata?.totalRatingsString}</p>
                    </div>
                </div>
                ...
                {<div>
                    <div className="flex mx-2 items-center my-5">
                        ...
                        <p className="mx-2 text-gray-700  font-bold text-lg mr-5 max-sm:text-sm" >{headerdata?.sla?.slaString}</p>
                        <IndianRupee className=" text-gray-700 size-7 p-[2px]  rounded-full max-sm:size-6" />
                        <p className=" text-gray-700  font-bold text-lg uppercase max-sm:text-sm" >{headerdata?.costForTwo / 100} for two</p>
                    </div>
                </div>}
            </div>
