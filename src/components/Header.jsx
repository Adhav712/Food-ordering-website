    ...
    return (
      ...
      shadow-lg shadow-gray-300 px-32'>
            ...
            <div className='flex justify-center items-center pb-4'>
                <Link to={'/home'}> <img src={images} alt="logo" className='w-56  mx-5 max-sm:w-56 py-5  overflow-hidden' /></Link>
            </div>
            ...
            <ul className='flex items-center justify-center pb-4'>
                ...
                <Link
                    to={'/offers'}>
                    <li
                        className='flex justify-center items-center  outline-none text-[1.4em] text-gray-500 font-semibold max-sm:text-md max-sm:text-[15px] max-sm:mx-[0.4em] hover:text-[#fca729]'>
                        <BadgePercent className='mx-1 max-sm:pb-1 mb-[0.1em] text-gray-500 hover:text-[#fca729] w-[24px] max-sm:w-[18px] max-sm:mx-[2px]' />
                        Offers</li></Link>
                <Link to={'/carts'}> <li
                    className=' flex justify-center items-center  outline-none  mx-4 text-[1.4em] text-gray-500 max-sm:text-[15px] font-semibold max-sm:text-md max-sm:mx-[0.4em] hover:text-[#fca729]'>

                    <ShoppingCart className='mx-2 text-gray-500 hover:text-[#fca729] w-[24px] max-sm:w-[18px] max-sm:mx-[2px]' />
                    Carts :  <span className='text-[#fca729] mx-1 max-sm:pb-1 mb-[0.1em] '> {selector.length}</span></li>
                </Link>
