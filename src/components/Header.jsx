...
export const Header = () => {
    ...
    return (
        <div className='overflow-hidden flex justify-between items-end  m-2
          max-sm:block max-md:px-1 max-lg:block  
      shadow-lg shadow-gray-300 px-32'>

            <div className='flex justify-center'>
                <Link to={'/home'}> <img src={images} alt="logo" className='w-72  mx-5 max-sm:w-56 py-5  overflow-hidden' /></Link>
            </div>

            <ul className='flex items-center justify-center pb-4'>
                <Link to={'/home'}>
                    <li className=' flex justify-center items-end  outline-none mx-2 text-[1.4em] 
                     text-gray-500 font-semibold  max-sm:text-[15px]  max-xl:text-md  max-sm:mx-[0.4em] hover:text-[#fca729] '>
                        ...
                        Home</li></Link>
                <Link className='flex items-end  ' to={'/contact'}>
                    <li
                        className=' flex justify-center items-end  mx-4 outline-none text-[1.4em] text-gray-500 font-semibold max-sm:text-md max-sm:text-[15px] max-sm:mx-[0.4em] hover:text-[#fca729]' >
                ...
                <Link
                    to={'/offers'}>
                    <li
                        className='flex justify-center items-end  outline-none text-[1.4em] text-gray-500 font-semibold max-sm:text-md max-sm:text-[15px] max-sm:mx-[0.4em] hover:text-[#fca729]'>
                        <BadgePercent className='mx-1 text-gray-500 hover:text-[#fca729] w-[24px] max-sm:w-[18px] max-sm:mx-[2px]' />
                        Offers</li></Link>
                <Link to={'/carts'}> <li
                    className=' flex justify-center items-end  outline-none  mx-4 text-[1.4em] text-gray-500 max-sm:text-[15px] font-semibold max-sm:text-md max-sm:mx-[0.4em] hover:text-[#fca729]'>
