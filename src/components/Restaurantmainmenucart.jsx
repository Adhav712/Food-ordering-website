...
export const Restaurantmainmenucart = ({ data }) => {
    ...
    return data !== undefined && (
        <div className="">
            <div className=' my-4  mx-4 transition ease-out   hover:shadow-lg  hover:shadow-slate-500  delay-75  duration-100
...
export const withofferlabel = (Restaurantmainmenucart) => {
    return (data) => {
        ...
        return <div className="text-center">
           ...
           bg-gradient-to-t  from-gray-900  mx-8 rounded-b-lg py-1">{header} {subHeader}</h1>
        </div>
    }
}
